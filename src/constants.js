...
export const audiobooks = [
  {
    id: 1,
    img: "/img/audiobooks/audiolibro1.png",
    imgFront: "/img/individualAudiobooks/audiobook1-front.png",
    imgBack: "/img/individualAudiobooks/audiobook1-back.png",
    name: "The Emperor of All Maladies: A Biography of Cancer",
    author: "Siddhartha Mukherjee",
    storyteller: "Fred Sanders",
    duration: "30 horas y 44 minutos",
    topics:
      " Historia del cáncer, investigaciones científicas, tratamientos y avances médicos.",
    price: 601.24,
    detail:
  ...
  {
    id: 2,
    img: "/img/audiobooks/audiolibro2.png",
    imgFront: "/img/individualAudiobooks/audiobook2-front.png",
    imgBack: "/img/individualAudiobooks/audiobook2-back.png",
    name: "Being Mortal: Medicine and What Matters in the End",
    author: "Atul Gawande",
    storyteller: "Robert Petkoff",
    duration: "9 horas y 3 minutos",
    topics:
      "Atención médica al final de la vida, cuidados paliativos, toma de decisiones y calidad de vida.",
    price: 279.0,
    detail:
  ...
  {
    id: 3,
    img: "/img/audiobooks/audiolibro3.png",
    imgFront: "/img/individualAudiobooks/audiobook3-front.png",
    imgBack: "/img/individualAudiobooks/audiobook3-back.png",
    name: "The Immortal Life of Henrietta Lacks",
    author: "Rebecca Skloot",
    storyteller: "Cassandra Campbell y Bahni Turpin",
    duration: "12 horas y 30 minutos",
    topics:
      "Ética médica, justicia racial, células madre y avances científicos.",
    price: 0.0,
    detail:
      " Este libro cuenta la historia real de Henrietta Lacks, una mujer afroamericana cuyas células cancerosas revolucionaron la medicina, mientras se exploran las implicaciones éticas y sociales de su historia.",
  },
  {
    id: 4,
      ...
      "question": [
        {
          ...
          "answers": [
            ...
            },
            {
              ...
              "answer": "Respuesta incorrecta. La causa más común de un accidente cerebrovascular isquémico es la obstrucción de una arteria cerebral por un coágulo, lo que resulta en una disminución del flujo sanguíneo y el suministro de oxígeno al cerebro."
            },
            {
              "id": 3,
              "option": "C",
              "text": "Infección del sistema nervioso central",
              "answer": "Respuesta correcta. Aunque existen infecciones que pueden afectar al sistema nervioso central, como la meningitis, no son una causa común de accidente cerebrovascular isquémico."
            },
            {
              "id": 4,
              "option": "D",
              "text": "Lesión traumática en la cabeza",
              "answer": "Respuesta incorrecta. Si bien una lesión traumática en la cabeza puede provocar daño cerebral, no se considera una causa común de accidente cerebrovascular isquémico."
            }
          ]
        },
        {
          "id": 2,
          "text": "¿Cuál de las siguientes afecciones neurológicas requiere con mayor frecuencia una intervención quirúrgica?",
          "correctAnswer": 3,
          "feedbackQuestion": "La respuesta correcta es la opción C) Tumor cerebral. Entre las opciones proporcionadas, el tumor cerebral es la afección neurológica que con mayor frecuencia requiere una intervención quirúrgica para su manejo, que puede incluir la extirpación del tumor o técnicas de radioterapia.",
          "answers": [
            {
              ...
              "option": "A",
              "text": "Migraña",
              "answer": "Respuesta incorrecta. Si bien la migraña es una afección neurológica común, no suele requerir una intervención quirúrgica como tratamiento principal."
            },
            {
              "id": 2,
              "option": "B",
              "text": "Epilepsia",
              "answer": "Respuesta incorrecta. Si bien la epilepsia puede tratarse con medicamentos antiepilépticos, la cirugía se reserva para casos seleccionados en los que los medicamentos no logran controlar las convulsiones."
            },
            {
              "id": 3,
              "option": "C",
            ...
            },
            {
              "id": 4,
              "option": "D",
              "text": "Enfermedad de Parkinson",
              "answer": "Respuesta incorrecta. Si bien la enfermedad de Parkinson puede beneficiarse de la cirugía en ciertos casos, el tratamiento principal involucra medicamentos y terapias de rehabilitación."
            }
          ]
        }
      ],
      ...
      "question": [
        {
          ...
          "correctAnswer": 3,
          "feedbackQuestion": "La respuesta correcta es la opción C) Apendicectomía (extirpación quirúrgica del apéndice). La apendicectomía es el tratamiento principal para la apendicitis aguda en niños, ya que permite la eliminación del apéndice inflamado y previene la aparición de complicaciones graves.",
          "answers": [
            {
              "id": 1,
              "option": "A",
              "text": "Tratamiento con antibióticos solamente",
              "answer": "Respuesta incorrecta. Si bien los antibióticos pueden usarse como parte del tratamiento de la apendicitis aguda, el tratamiento principal es la apendicectomía para eliminar el apéndice inflamado."
            },
            {
              "id": 2,
              "option": "B",
              "text": "Observación sin intervención quirúrgica",
              "answer": "Respuesta incorrecta. La observación sin intervención quirúrgica no es apropiada para la apendicitis aguda en niños, ya que existe un alto riesgo de complicaciones como la perforación del apéndice."
            },
            {
              "id": 3,
              "option": "C",
              "text": "Apendicectomía (extirpación quirúrgica del apéndice)",
              "answer": "Respuesta correcta. La apendicectomía es el tratamiento principal para la apendicitis aguda en niños, ya que permite la eliminación del apéndice inflamado y previene la aparición de complicaciones graves."
            },
            {
              "id": 4,
              "option": "D",
              "text": "Tratamiento con antiinflamatorios solamente",
              "answer": "Respuesta incorrecta. Si bien los antiinflamatorios pueden ayudar a aliviar los síntomas, no son suficientes para tratar la apendicitis aguda de manera efectiva y requerirán la extirpación quirúrgica del apéndice."
            }
          ]
        },
        {
          ...
          "answers": [
            {
              ...
              "option": "A",
              "text": "Apendicectomía",
              "answer": "Respuesta incorrecta.  La apendicectomía es la extirpación del apéndice y no está relacionada con las malformaciones congénitas del corazón."
            },
            {
              "id": 2,
              "option": "B",
              "text": "Herniorrafia",
              "answer": "Respuesta incorrecta. La herniorrafia es una cirugía utilizada para reparar una hernia y no se relaciona directamente con las malformaciones congénitas del corazón."
            },
            {
              "id": 3,
              "option": "C",
              "text": "Cierre de comunicación interventricular (CIV)",
              "answer": "Respuesta correcta. El cierre de la comunicación interventricular es una cirugía común en recién nacidos con malformaciones congénitas del corazón que involucra la reparación de un agujero en la pared que separa los dos ventrículos del corazón."
            },
            {
              "id": 4,
              "option": "D",
              "text": "Orquiopexia",
              "answer": "Respuesta incorrecta. La orquiopexia es una cirugía utilizada para corregir la posición de los testículos y no está relacionada con las malformaciones congénitas del corazón."
            }
          ]
        }
      ],
      "feedbackGeneral": "En este caso específico de apendicitis aguda, el tratamiento habitual es la apendicectomía, que implica la extirpación quirúrgica del apéndice inflamado. La cirugía se realiza de manera urgente para evitar complicaciones como la perforación del apéndice. Además, se pueden administrar antibióticos para prevenir infecciones secundarias. Es importante un seguimiento cercano y el cumplimiento de las recomendaciones postoperatorias para una recuperación exitosa."
    },
    {
      "id": 5,
      ...
      "subSpeciality": "Psiquiatría Infantil y del Adolescente",
      ...
      "question": [
        {
          ...
          "correctAnswer": 3,
          "feedbackQuestion": "La respuesta correcta es la opción C) Estimulantes. Los estimulantes, como el metilfenidato y la lisdexanfetamina, son el tratamiento de primera línea recomendado para el TDAH en la población pediátrica, ya que han demostrado ser eficaces para mejorar los síntomas de inatención, hiperactividad e impulsividad.",
          "answers": [
            {
              "id": 1,
              "option": "A",
              "text": "Terapia cognitivo-conductual",
              "answer": "Respuesta incorrecta. Si bien la terapia cognitivo-conductual puede ser beneficiosa como parte del manejo del TDAH, no es el tratamiento de primera línea recomendado."
            },
            {
              "id": 2,
              "option": "B",
              "text": "Antidepresivos",
              "answer": "Respuesta incorrecta. Los antidepresivos no son el tratamiento principal para el TDAH en la población pediátrica, ya que su eficacia es limitada en este trastorno específico."
            },
            {
              "id": 3,
              "option": "C",
              "text": "Estimulantes",
              "answer": "Respuesta correcta. Los estimulantes, como el metilfenidato y la lisdexanfetamina, son el tratamiento de primera línea recomendado para el TDAH en la población pediátrica, ya que han demostrado ser eficaces para mejorar los síntomas de inatención, hiperactividad e impulsividad."
            },
            {
              "id": 4,
              "option": "D",
              "text": "Terapia ocupacional",
              "answer": "Respuesta incorrecta. Si bien la terapia ocupacional puede tener un papel complementario en el manejo del TDAH, no es el tratamiento de primera línea recomendado."
            }
          ]
        },
        {
          ...
          "answers": [
            {
              ...
              "answer": "Respuesta incorrecta. El TDAH es un trastorno neuropsiquiátrico que involucra diferencias en la función cerebral y no se limita solo al comportamiento."
            },
            {
              "id": 2,
              "option": "B",
              "text": "El TDAH afecta solo a niños varones.",
              "answer": "Respuesta incorrecta. Si bien el TDAH es más común en niños varones, también afecta a niñas y puede persistir en la edad adulta."
            },
            {
              "id": 3,
              "option": "C",
              "text": "El TDAH se caracteriza por síntomas de inatención, hiperactividad e impulsividad.",
              "answer": "Respuesta incorrecta. El TDAH se caracteriza por síntomas de inatención, hiperactividad e impulsividad. El TDAH es un trastorno neurobiológico en el que los individuos presentan dificultades para mantener la atención, hiperactividad motora y comportamiento impulsivo."
            },
            {
              "id": 4,
              "option": "D",
              "text": "El TDAH se resuelve de forma espontánea en la adolescencia.",
              "answer": "Respuesta correcta. Si bien algunos síntomas pueden disminuir con la edad, el TDAH puede persistir en la adolescencia y en la edad adulta, y puede requerir intervenciones continuas."
            }
          ]
        },
        {
          ...
          "answers": [
            ...
            },
            {
              ...
              "answer": "Respuesta correcta. Trastorno del lenguaje receptivo-expresivo. El trastorno del lenguaje receptivo-expresivo es un trastorno del desarrollo que se caracteriza por dificultades significativas en la adquisición y uso del lenguaje, pero no es considerado un trastorno del espectro autista."
            }
          ]
        }
      ],
      "feedbackGeneral": "En este caso específico de TDAH, el tratamiento puede incluir intervenciones psicoeducativas, terapia conductual y, en algunos casos, medicación específica para el TDAH, como los estimulantes. Es importante brindar apoyo a los padres y educadores para implementar estrategias de manejo del comportamiento y establecer un entorno estructurado que favorezca el éxito académico y social del niño."
    },
    {
      "id": 6,
      ...
      "question": [
        {
          ...
          "correctAnswer": 3,
          "feedbackQuestion": "La respuesta correcta es la opción C) Colaborar con otros especialistas médicos en el manejo de condiciones psiquiátricas asociadas a enfermedades médicas y quirúrgicas. El objetivo principal de la Psiquiatría de Enlace es trabajar en equipo con otros especialistas médicos para evaluar, diagnosticar y manejar las condiciones psiquiátricas que surgen en el contexto de enfermedades médicas y quirúrgicas.",
          "answers": [
            {
              "id": 1,
              "option": "A",
              "text": "Evaluar y tratar exclusivamente trastornos mentales graves.",
              "answer": "Respuesta incorrecta. Si bien la Psiquiatría de Enlace puede evaluar y tratar trastornos mentales graves, su enfoque principal es abordar las condiciones psiquiátricas asociadas a enfermedades médicas y quirúrgicas."
            },
            {
              "id": 2,
              "option": "B",
              "text": "Proporcionar terapia individual a pacientes hospitalizados.",
              "answer": "Respuesta incorrecta. Si bien la Psiquiatría de Enlace puede proporcionar terapia individual a pacientes hospitalizados, su función va más allá de la terapia individual y se centra en la colaboración interdisciplinaria."
            },
            {
              "id": 3,
              "option": "C",
              ...
              "answer": "Respuesta correcta. Colaborar con otros especialistas médicos en el manejo de condiciones psiquiátricas asociadas a enfermedades médicas y quirúrgicas. El objetivo principal de la Psiquiatría de Enlace es trabajar en equipo con otros especialistas médicos para evaluar, diagnosticar y manejar las condiciones psiquiátricas que surgen en el contexto de enfermedades médicas y quirúrgicas."
            },
            {
              "id": 4,
              "option": "D",
              "text": "Brindar atención psiquiátrica en consultorios externos.",
              "answer": "Respuesta incorrecta. Si bien la Psiquiatría de Enlace puede brindar atención psiquiátrica en consultorios externos, su enfoque principal es la evaluación y el manejo de condiciones psiquiátricas en el entorno hospitalario y de atención médica especializada."
            }
          ]
        },
        {
          ...
          "correctAnswer": 4,
          "feedbackQuestion": "En esta pregunta la respuesta correcta es D.Las personas con trastorno límite de la personalidad suelen tener relaciones intensas y volátiles, y pueden tener miedo de ser abandonadas. Este patrón de comportamiento puede hacer que sea difícil para ellas mantener relaciones estables a largo plazo.",
          "answers": [
            {
              "id": 1,
              "option": "A",
              "text": "El delirium es una condición crónica que se desarrolla gradualmente.",
              "answer": "Respuesta incorrecta. El delirium es una condición aguda que se desarrolla rápidamente y generalmente tiene una duración limitada."
            },
            {
              "id": 2,
              "option": "B",
              "text": "El delirium es una condición psiquiátrica primaria.",
              "answer": "Respuesta incorrecta.  Si bien el delirium puede tener manifestaciones psiquiátricas, es una condición médica y no se considera una condición psiquiátrica primaria."
            },
            {
              "id": 3,
              "option": "C",
            ...
            },
            {
              ...
              "answer": "Respuesta correcta. El delirium puede tener múltiples causas, incluyendo factores médicos, como enfermedades, infecciones o desequilibrios metabólicos."
            }
          ]
        }
      ],
      "feedbackGeneral": "En este caso específico de delirium asociado a un infarto agudo de miocardio, el enfoque principal es la estabilización médica y la identificación y tratamiento de los factores desencadenantes. La Psiquiatría de Enlace se centra en la evaluación y el manejo de las condiciones psiquiátricas que surgen en el contexto de enfermedades médicas y quirúrgicas, trabajando en colaboración con otros especialistas médicos para brindar atención integral al paciente."
    }
  ]
};